...
# Known problems
  - If your character appears naked, start the game, logout and then start the game again. This should resolve the problem. This wont likely to happen with the new parser.
  - Steam sync seems to be causing problems when you change your character name. Disabling it is recommended.
  - For some reason the game does not likes some customizations and may reset one or more of your skills. This wont likely to happen with the new parser.
